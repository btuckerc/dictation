...
fn default_post_process_prompts() -> Vec<LLMPrompt> {
    vec![LLMPrompt {
        id: "technical_cleanup".to_string(),
        name: "Technical dictation".to_string(),
        prompt: crate::dictation::CLEANUP_PROMPT.to_string(),
    }]
}
...
pub fn get_default_settings() -> AppSettings {
    ...
    AppSettings {
        ...
        custom_words: crate::dictation::vocabulary(),
...
/// Upstream self-updates are disabled in this independently distributed fork.
pub fn update_checks_forced_disabled() -> bool {
    // This fork must never replace itself with an upstream Handy release.
    true
}
