...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/btuckerc/dictation"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("Dictation/0.1.0 (+https://github.com/btuckerc/dictation)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Dictation"));
