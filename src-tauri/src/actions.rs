        ...
        match rm.try_start_recording(&binding_id, vad_policy) {
            Ok(readiness) => {
                ...
                std::thread::spawn(move || {
                    ...
                    if let Ok(delay_ms) = std::env::var("DICTATION_DEBUG_MIC_READY_DELAY_MS")
                        .unwrap_or_default()
                        .parse::<u64>()
                    {
        ...
        tauri::async_runtime::spawn(async move {
            ...
            if let Some(samples) = rm.stop_recording(&binding_id, cancel_generation) {
                ...
                if samples.is_empty() {
                    ...
                    let file_name = format!("dictation-{}.wav", chrono::Utc::now().timestamp());
                    ...
                    match transcription_result {
                        ...
                        Err(err) => {
                            ...
                            // message is also in dictation.log via the line above.
