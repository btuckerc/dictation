//! Model capability probing — the seam between Dictation's model UI and "what can
...
/// How confident we are that Dictation can run a given model, judged from its GGUF
